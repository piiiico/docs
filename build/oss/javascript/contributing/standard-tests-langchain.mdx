...
To see the complete list of configurable capabilities and their defaults, see [Implementing standard tests](/oss/javascript/javascript/contributing/standard-tests-langchain#implementing-standard-tests).
...
For a full list of the standard test suites that are available, as well as information on which tests are included and how to troubleshoot common issues, see [Using standard tests](/oss/javascript/javascript/contributing/standard-tests-langchain#using-standard-tests).
