...
- **[Filter and group by models, prompts, and tools](#filter-and-group-by-models-prompts-and-tools)**: Use **Models, **Prompts**, and **Tools** columns to filter and group experiments in the table view.
...
<img
  ...
  alt="The experiments table with metadata columns for models, prompts, and tools."
/>
